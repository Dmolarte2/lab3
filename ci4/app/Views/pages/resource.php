...
a.ex3:hover, a.ex2:active {font-size: 110%;}
</style>
</head>


<body style="background-color:#E2E8CE;cursor: url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/9632/happy.png), auto">
  ...
  <div class="w3-content w3-justify w3-padding-64" id="about">
    ...
    <h2 style="font-color:#0F0F0F;font-size:40px" >Resources</h2>
  ...
  <div class=" w3-content" id="contact">
    ...
    <h2 style="font-color:#0F0F0F;padding-top:100px">Contact Me</h2>
